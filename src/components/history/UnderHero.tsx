  ...
  return (
    <section className="border-t-2 border-red-600 w-full p-8 space-y-4">
      ...
      <p className="text-sm">
        ...
        passionate practitioner and dedicated instructor in the art of Brazilian
        Jiu-Jitsu. Our academy has quickly become a hub for martial arts
        enthusiasts in the picturesque town of Chorley, Lancashire.
      </p>
      <p className="text-sm">
        <span className="font-bold text-red-600">
        ...
        Inspired by his own journey through the art and his desire to share its
        numerous benefits, he took the bold step of establishing the academy to
        create a nurturing environment for aspiring grapplers of all levels.
      </p>
      <p className="text-sm">
      ...
      <p className="text-sm">
        Since its inception,{" "}
        <span className="font-bold text-red-600">Stalone BJJ Chorley</span> has
        experienced remarkable growth, attracting students from various
        ...
        sport, the academy provides a supportive and encouraging environment to
        help them achieve their aspirations.
      </p>
      <p className="text-sm">
        Under{" "}
        <span className="text-red-600 font-bold">Professor Stalone&apos;s</span>{" "}
      ...
      <p className="text-sm">
        Beyond the mats,{" "}
        <span className="font-bold text-red-600">Stalone BJJ Chorley</span> has
        been actively involved in the local community, organising workshops,
        charity events, and seminars to spread awareness about the art of
        Brazilian Jiu-Jitsu and its positive impact on individuals and society.
      </p>
      ...
      <p className="text-sm">
        ...
        Jiu-Jitsu while embracing innovation and growth. We continue to welcome
        new members into our vibrant community, ensuring that the spirit of{" "}
        <span className="font-bold text-red-600">Professor Stalone&apos;s</span>{" "}
      ...
      <p className="text-sm">
        ...
        become part of our journey in mastering the art of Brazilian Jiu-Jitsu
        while nurturing a strong body, mind, and spirit. Whether you are a
        beginner or an experienced practitioner, our doors are always open to
