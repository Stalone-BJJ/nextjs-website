    ...
    <div className="px-8 py-4 w-full">
      ...
      {!showSuccessMessage ? (
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange}>
                    ...
                    <SelectContent>
                      <SelectItem value="All Levels Class">
                        All Levels
                      </SelectItem>
                      ...
                      <SelectItem value="Womens Only Class">
                        Womens Only
                      </SelectItem>
                    </SelectContent>
                  </Select>
        ...
        <div className="space-y-2 text-sm">
          ...
          <p>
            We&apos;ve received your request and will be in touch with you
            shortly.
          </p>
          <p>
            Please ensure to check your spam folder if you haven&apos;t received
